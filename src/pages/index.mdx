...
import FrontRocket from "../assets/Front-rocket.png";
import TopViewRocket from "../assets/Top view Rokect.png";
...
<TwoColumns>
  <Figure>
    <Picture src={FrontRocket} alt="Front view of the rocket" />
    Front view of our "Tie Advanced" inspired rocket.
  </Figure>
  <Figure>
    <Picture src={TopViewRocket} alt="Top view of the rocket" />
    Top view of our "Tie Advanced" inspired rocket.
  </Figure>
</TwoColumns>
